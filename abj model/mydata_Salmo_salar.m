...
metaData.data_1     = {'T-ah';'T-ab';'t-L_f';'t-Wwe_T';'t-WwVe_T';'t-Ww_T';'L-Ww'}; % uni-variate data labels:  http://www.debtheory.org/wiki/index.php?title=Univariate_data 
...
%  temp.Lh = C2K(8);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.79;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Peterson1977';  comment.Wwh = 'parents from Dennis Stream (New Brunswick - Canada)';
%  temp.Lh = C2K(10);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.66;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Peterson1977';  comment.Wwh = 'parents from Dennis Stream (New Brunswick - Canada)';
%  temp.Lh = C2K(12);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.93;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Peterson1977';  comment.Wwh = 'parents from Miramichi River (New Brunswick - Canada)';
%  temp.Lh = C2K(4);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.87;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Peterson1977';  comment.Wwh = 'parents from Miramichi River (New Brunswick - Canada)';
%  temp.Lh = C2K(6);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.84;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Peterson1977';  comment.Wwh = 'parents from Miramichi River (New Brunswick - Canada)';
%  temp.Lh = C2K(8);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.73;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Peterson1977';  comment.Wwh = 'parents from Miramichi River (New Brunswick - Canada)';
%  temp.Lh = C2K(10);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.62;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Peterson1977';  comment.Wwh = 'parents from Miramichi River (New Brunswick - Canada)';
%  temp.Lh = C2K(12);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';
%data.Lh  = 1.8;   units.Lh  = 'cm';  label.Lh  = 'total length at hatching';   bibkey.Lh  = 'Srivastava1991';  comment.Wwh = 'parents from Northeast Placentia River (Newfoundland, Canada)';
%  temp.Lh = C2K(7);  units.temp.Lh = 'K'; label.temp.Lh = 'temperature';

%% Length at first feeding

  data.Lb  = 2.825;   units.Lb  = 'cm';  label.Lb  = 'total length at birth';   bibkey.Lb  = 'VanLeeuwen2016';  comment.Wwb = 'parents from River Blackwater (Scotland) - 1SW mother';
...
data.Li  = 95;   units.Li  = 'cm';  label.Li  = 'ultimate total length';   bibkey.Li  = 'Fleming1996'; comment.Li = 'maximum of Scottish populations maxima - females';
...
%% Egg volume
  data.V0 = 0.090;  units.V0 = 'cm^3'; label.V0 = 'egg volume'; bibkey.V0 = 'Berg2001';  comment.V0 = 'parents from river Stj√∏rdalselva (Norway)';
...
% data.Ww0 = 0.104;  units.Ww0 = 'g'; label.Ww0 = 'wet egg weight'; bibkey.Ww0 = 'Berg2001';  comment.Ww0 = 'before fertilization - parents from river Stj√∏rdalselva (Norway)';
...
% data.Wd0 = 0.039;  units.Wd0 = 'g'; label.Wd0 = 'dry egg weight'; bibkey.Wd0 = 'Srivastava1991';  comment.Wd0 = 'after fertilization - parents from Northeast Placentia River (Newfoundland, Canada)';
  data.Wd0 = 0.035;  units.Wd0 = 'g'; label.Wd0 = 'dry egg weight'; bibkey.Wd0 = 'Berg2001';  comment.Wd0 = 'before fertilization - parents from river Stj√∏rdalselva (Norway)';
...
data.Wwb = 0.16;   units.Wwb = 'g';   label.Wwb = 'wet weight at birth';     bibkey.Wwb = 'VanLeeuwen2016';  comment.Wwb = 'parents from River Blackwater (Scotland) - 1SW mother';
...
% data.E0 = 1028; units.E0 = 'J'; label.E0 = 'egg reserve energy'; bibkey.E0 = 'Srivastava1991';   comment.E0 = 'after fertilization - parents from Northeast Placentia River (Newfoundland, Canada)';
  data.E0 = 757; units.E0 = 'J'; label.E0 = 'egg reserve energy'; bibkey.E0 = 'Berg2001';   comment.E0 = 'before fertilization - parents from river Stj√∏rdalselva (Norway)';
...
data.Ri  = 14499/365.25;   units.Ri  = '#/d'; label.Ri  = 'maximum reprod rate';     bibkey.Ri  = 'Thorpe1984';   comment.Ri = 'maximum at River Almond (Scotland)';
  temp.Ri = C2K(10);    units.temp.Ri = 'K'; label.temp.Ri = 'temperature'; comment.temp.Ri = 'highly variable temperature throughout life';
...
%data.Tah(:,1)=C2K(data.Tah(:,1));
%units.Tah   = {'K', 'd'};  label.Tah = {'temperature', 'age at hatching'}; 
%bibkey.Tah = 'Solberg2014'; comment.Tah = 'parents from Norwegian wild and domestic stock - no differences between wild and domestic - temperature range up to 4 degrees for a given cohort so temperature differences not very relevant';

%% T-ab data

% data.Tab_Peterson1977 = [ ... % temperature (∞C), age at yolk exhaustion (d)
% 2 238
% 6 177
% 12  64];
...
data.Tab = [ ... % temperature (∞C), age at emergence (d)
0.0 390.6
0.4 357.8
1.0 315.6
1.6 278.1
...
%temp.tL    = C2K(10);  units.temp.tL = 'K'; label.temp.tL = 'temperature'; comment.temp.tL = 'temperature between 8 and 12∞C';
...
bibkey.LWw_spawners = 'Berg2001'; comment.LWw_spawners = 'females from river Stj√∏rdalselva (Norway)';
...
weights.tWw_T4 = weights.tWw_T4/6;
weights.tWw_T8 = weights.tWw_T8/6;
weights.tWw_T6 = weights.tWw_T6/6;
...
weights.tWw_f100 = weights.tWw_f100/4;
weights.V0 = 3*weights.V0 ; 
...
'year = {1935}, ' ...
'title = {Further notes on the duration of life in animals. - I. Fishes: as determined by otolith and scale - readings and direct observations on living animals.}, ' ...
...
'year = {1998}, ' ...
'title = {Life history variation and growth rate thresholds for maturity in Atlantic salmon, Salmo salar}, ' ...
...
'year = {2006}, ' ...
'title = {Long-term changes in the smolt size and age of Atlantic salmon, Salmo salar L., in a northern Baltic river related to parr density, growth opportunity and postsmolt survival.}, ' ...
...
'year = {1984}, ' ...
'title = {Developmental rate, fecundity and egg size in Atlantic salmon, Salmo salar L.}, ' ...
'journal = {Aquaculture}, ' ...
'volume = {43}, ' ...
'number = {1-3}, ' ...
...
'year = {1998}, ' ...
'title = {Long-term study of the ecology of wild Atlantic salmon smolts in a small Norwegian river}, ' ...
...
'author = {Kazarov, R. V.}, ' ... 
'year = {1981}, ' ...
'title = {The effect of the size of Atlantic salmon, Salmo salar L., eggs on embryos and alevins}, ' ...
'journal = {Journal of Fish Biology}, ' ...
'volume = {19}, ' ...
'doi = {10.1016/0044-8486(84)90030-9}, ' ...
...
'year = {1977}, ' ...
'title = {Development of Atlantic Salmon (Salmo salar) Eggs and Alevins Under Varied Temperature Regimes}, ' ...
...
'author = {Handeland, S. O. and Berge, A. and Bj√∂rnsson, B. T. and Stefansson, S. O.}, ' ... 
'year = {1998}, ' ...
...
'year = {1991}, ' ...
'title = {The biochemical characteristics and hatching performance of cultured and wild Atlantic salmon (Salmo salar) eggs}, ' ...
...
'year = {1988}, ' ...
'title = {Incubation of eggs of Atlantic salmon (Salmo salar)  from different Norwegian streams at  temperatures below 1∞C.}, ' ...
...
'year = {1989}, ' ...
'title = {Photoperiod and temperature effects on early development and reproductive investment in Atlantic salmon (Salmo salar L.).}, ' ...
'journal = {Aquaculture}, ' ...
'volume = {79}, ' ...
'number = {1-4}, ' ...
...
'year = {1997}, ' ...
'title = {Tissue indicators of element status in Atlantic salmon (Salmosalar) post-smolts: effect of fasting}, ' ...
...
'author = {Gunnes, Knut}, ' ... 
'year = {1979}, ' ...
'title = {Survival and development of Atlantic salmon eggs and fry at three different temperatures}, ' ...
'journal = {Aquaculture}, ' ...
'volume = {16}, ' ...
...
'year = {2001}, ' ...
'title = {Maternal provisioning of offspring and the use of those resources during ontogeny: variation within and between Atlantic Salmon families}, ' ...
